...
<div class="modal" id="dataModal">
    <div class="modal-content">
        ...
        <div style="margin-top:20px;">
            <label><b>Pesan dan Kesan dari Dunia Usaha / Industri :</b></label>
            <textarea id="pesanInput" placeholder="Tulis pesan dan kesan di sini..."></textarea>
...
function simpanCatatan() {
    ...
    $.post("simpan_catatan.php", { nis: currentNIS, pesan: pesan }, function(res) {
        alert(res.message);
    }, "json");
}
</script>
