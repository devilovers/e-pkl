...
<style>
    ...
    .modal-content { background: white; padding: 28px 25px; border-radius: 10px; max-width: 800px; width: 95%; position: relative; }
...
function simpanCatatan() {
    ...
    if (!currentNIS || !currentSiswaId) return;

    $.post("simpan_hadir.php", { 
        nis: currentNIS, 
        id_siswa: currentSiswaId,
        pesan: pesan,
        status: status
    }, function(res) {
        alert(res.message);
